...
@protocol SWGSystemPromptAssetEntityListing
@end

@interface SWGSystemPromptAssetEntityListing : SWGObject


@property(nonatomic) NSArray<SWGSystemPromptAsset>* entities;
