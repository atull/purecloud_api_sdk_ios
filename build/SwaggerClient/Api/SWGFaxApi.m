...
-(NSNumber*) deleteFaxDocumentsDocumentIdWithDocumentId: (NSString*) documentId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/fax/documents/{documentId}"];
...
///
///  @returns SWGFaxDocumentEntityListing*
///
-(NSNumber*) getFaxDocumentsWithPageSize: (NSNumber*) pageSize
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/fax/documents"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGFaxDocumentEntityListing*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGFaxDocumentEntityListing*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getFaxDocumentsDocumentIdWithDocumentId: (NSString*) documentId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGFaxDocument*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGFaxDocument*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getFaxDocumentsDocumentIdContentWithDocumentId: (NSString*) documentId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/fax/documents/{documentId}/content"];
...
-(NSNumber*) getFaxSummaryWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/fax/summary"];
