...
@interface SWGGreetingsApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGGreetingsApi

NSString* kSWGGreetingsApiErrorDomain = @"SWGGreetingsApiErrorDomain";
NSInteger kSWGGreetingsApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGGreetingsApi *sharedAPI;
...
-(NSNumber*) deleteGreetingsGreetingIdWithGreetingId: (NSString*) greetingId
    ...
    if (greetingId == nil) {
        NSParameterAssert(greetingId);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"greetingId"] };
            NSError* error = [NSError errorWithDomain:kSWGGreetingsApiErrorDomain code:kSWGGreetingsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/greetings/{greetingId}"];
    ...
    if (greetingId != nil) {
        pathParams[@"greetingId"] = greetingId;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGGreeting*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGGreeting*)data, error);
                                }
                           }
          ];
}
...
///
///  @returns SWGDomainEntityListing*
///
-(NSNumber*) getGreetingsWithPageSize: (NSNumber*) pageSize
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/greetings"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGDomainEntityListing*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGDomainEntityListing*)data, error);
                                }
                           }
          ];
}
...
/// 
///  @returns SWGDefaultGreetingList*
///
-(NSNumber*) getGreetingsDefaultsWithCompletionHandler: 
    (void (^)(SWGDefaultGreetingList* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/greetings/defaults"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGDefaultGreetingList*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGDefaultGreetingList*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getGreetingsGreetingIdMediaWithGreetingId: (NSString*) greetingId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/greetings/{greetingId}/media"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGGreetingMediaInfo*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGGreetingMediaInfo*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getUsersUserIdGreetingsWithUserId: (NSString*) userId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/users/{userId}/greetings"];
...
-(NSNumber*) getUsersUserIdGreetingsDefaultsWithUserId: (NSString*) userId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/users/{userId}/greetings/defaults"];
