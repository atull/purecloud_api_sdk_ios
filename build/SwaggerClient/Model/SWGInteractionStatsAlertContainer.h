...
@protocol SWGInteractionStatsAlertContainer
@end

@interface SWGInteractionStatsAlertContainer : SWGObject


@property(nonatomic) NSArray<SWGInteractionStatsAlert>* entities;
