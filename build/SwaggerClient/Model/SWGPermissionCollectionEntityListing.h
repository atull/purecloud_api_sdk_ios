...
@protocol SWGPermissionCollectionEntityListing
@end

@interface SWGPermissionCollectionEntityListing : SWGObject


@property(nonatomic) NSArray<SWGDomainPermissionCollection>* entities;
