...
NSString* kSWGLanguagesApiErrorDomain = @"SWGLanguagesApiErrorDomain";
NSInteger kSWGLanguagesApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGLanguagesApi *sharedAPI;
...
-(NSNumber*) deleteLanguagesLanguageIdWithLanguageId: (NSString*) languageId
    ...
    if (languageId == nil) {
        NSParameterAssert(languageId);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"languageId"] };
            NSError* error = [NSError errorWithDomain:kSWGLanguagesApiErrorDomain code:kSWGLanguagesApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/languages/{languageId}"];
    ...
    if (languageId != nil) {
        pathParams[@"languageId"] = languageId;
    }
...
///
///  @returns SWGLanguageEntityListing*
///
-(NSNumber*) getLanguagesWithPageSize: (NSNumber*) pageSize
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/languages"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGLanguageEntityListing*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGLanguageEntityListing*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getLanguagesLanguageIdWithLanguageId: (NSString*) languageId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGLanguage*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGLanguage*)data, error);
                                }
                           }
          ];
}
...
/// 
///  @returns SWGAvailableTranslations*
///
-(NSNumber*) getLanguagesTranslationsWithCompletionHandler: 
    (void (^)(SWGAvailableTranslations* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/languages/translations"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGAvailableTranslations*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGAvailableTranslations*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getLanguagesTranslationsBuiltinWithLanguage: (NSString*) language
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/languages/translations/builtin"];
...
-(NSNumber*) getLanguagesTranslationsOrganizationWithLanguage: (NSString*) language
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/languages/translations/organization"];
...
-(NSNumber*) getLanguagesTranslationsUsersUserIdWithUserId: (NSString*) userId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/languages/translations/users/{userId}"];
