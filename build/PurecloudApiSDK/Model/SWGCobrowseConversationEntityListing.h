...
@protocol SWGCobrowseConversationEntityListing
@end

@interface SWGCobrowseConversationEntityListing : SWGObject


@property(nonatomic) NSArray<SWGCobrowseConversation>* entities;
