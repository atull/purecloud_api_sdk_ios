...
@protocol SWGEvaluatorActivityEntityListing
@end

@interface SWGEvaluatorActivityEntityListing : SWGObject


@property(nonatomic) NSArray<SWGEvaluatorActivity>* entities;
