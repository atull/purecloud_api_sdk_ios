...
@protocol SWGTextTableTransformEntityListing
@end

@interface SWGTextTableTransformEntityListing : SWGObject


@property(nonatomic) NSArray<SWGTextTableTransform>* entities;
