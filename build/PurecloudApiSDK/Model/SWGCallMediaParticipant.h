...
@protocol SWGCallMediaParticipant
@end

@interface SWGCallMediaParticipant : SWGObject
...
/* Value is true when the call is muted. [optional]
 */
@property(nonatomic) NSNumber* muted;
/* Value is true when the call is confined. [optional]
 */
@property(nonatomic) NSNumber* confined;
/* Value is true when the call is being recorded. [optional]
 */
@property(nonatomic) NSNumber* recording;
/* The state of the call recording. [optional]
 */
@property(nonatomic) NSString* recordingState;
/* The group involved in the group ring call. [optional]
 */
@property(nonatomic) SWGUriReference* group;
/* The call ANI. [optional]
 */
@property(nonatomic) NSString* ani;
/* The call DNIS. [optional]
 */
@property(nonatomic) NSString* dnis;
/* The ID of the Content Management document if the call is a fax. [optional]
 */
@property(nonatomic) NSString* documentId;
/* Extra fax information if the call is a fax. [optional]
 */
@property(nonatomic) SWGFaxStatus* faxStatus;
/* The ID of the participant being monitored when performing a call monitor. [optional]
 */
@property(nonatomic) NSString* monitoredParticipantId;
/* The ID of the consult transfer target participant when performing a consult transfer. [optional]
 */
