...
@protocol SWGDomainThirdPartySubscriptionEntityListing
@end

@interface SWGDomainThirdPartySubscriptionEntityListing : SWGObject


@property(nonatomic) NSArray<SWGThirdPartySubscription>* entities;
