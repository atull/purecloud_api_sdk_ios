...
@protocol SWGReportRunEntryEntityDomainListing
@end

@interface SWGReportRunEntryEntityDomainListing : SWGObject


@property(nonatomic) NSArray<SWGReportRunEntry>* entities;
