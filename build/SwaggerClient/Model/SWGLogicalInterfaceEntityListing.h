...
@protocol SWGLogicalInterfaceEntityListing
@end

@interface SWGLogicalInterfaceEntityListing : SWGObject


@property(nonatomic) NSArray<SWGDomainLogicalInterface>* entities;
