...
@protocol SWGFlowReportSearchResult
@end

@interface SWGFlowReportSearchResult : SWGObject
...
/* Search results 
 */
@property(nonatomic) NSArray<SWGFlowReportResultItem>* results;

@property(nonatomic) NSArray<SWGFacetResult>* aggregations;
