...
public class ININSequenceSchedule: JSONEncodable {
    ...
    public var sequence: ININUriReference?
    ...
    func encodeToJSON() -> AnyObject {
        ...
        nillableDictionary["sequence"] = self.sequence?.encodeToJSON()
