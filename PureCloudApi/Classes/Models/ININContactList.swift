...
public class ININContactList: JSONEncodable {
    ...
    public var phoneColumns: [ININContactPhoneNumberColumn]?
    ...
    func encodeToJSON() -> AnyObject {
        ...
        nillableDictionary["columnNames"] = self.columnNames?.encodeToJSON()
        ...
        nillableDictionary["previewModeColumnName"] = self.previewModeColumnName
        nillableDictionary["previewModeAcceptedValues"] = self.previewModeAcceptedValues?.encodeToJSON()
