...
@protocol SWGInteractionStatsRuleContainer
@end

@interface SWGInteractionStatsRuleContainer : SWGObject


@property(nonatomic) NSArray<SWGInteractionStatsRule>* entities;
