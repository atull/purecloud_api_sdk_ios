...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"_id", @"name", @"calibrator", @"agent", @"conversation", @"evaluationForm", @"contextId", @"averageScore", @"highScore", @"lowScore", @"createdDate", @"evaluations", @"evaluators", @"scoringIndex", @"expertEvaluator", @"selfUri"];
