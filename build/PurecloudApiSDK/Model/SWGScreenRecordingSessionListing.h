...
@protocol SWGScreenRecordingSessionListing
@end

@interface SWGScreenRecordingSessionListing : SWGObject


@property(nonatomic) NSArray<SWGScreenRecordingSession>* entities;
