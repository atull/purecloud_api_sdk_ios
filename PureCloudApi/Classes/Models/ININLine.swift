...
public class ININLine: JSONEncodable {
    ...
    public var template: ININUriReference?
    public var site: ININUriReference?
    public var lineBaseSettings: ININUriReference?
    public var primaryEdge: ININEdge?
    public var secondaryEdge: ININEdge?
    public var loggedInUser: ININUriReference?
    ...
    func encodeToJSON() -> AnyObject {
        ...
        nillableDictionary["loggedInUser"] = self.loggedInUser?.encodeToJSON()
