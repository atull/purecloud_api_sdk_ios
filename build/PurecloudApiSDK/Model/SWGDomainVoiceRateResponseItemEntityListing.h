...
@protocol SWGDomainVoiceRateResponseItemEntityListing
@end

@interface SWGDomainVoiceRateResponseItemEntityListing : SWGObject


@property(nonatomic) NSArray<SWGVoiceRate>* entities;
