//
// ININWorkItemSearchDetailsSearchResult.swift
//
...
public class ININWorkItemSearchDetailsSearchResult: JSONEncodable {
    /** The actual results from the search */
    public var searchResults: ININLinkedEntityListingWorkItemSearchDetails?
