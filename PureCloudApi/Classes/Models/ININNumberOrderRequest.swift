...
public class ININNumberOrderRequest: JSONEncodable {
    ...
    public var orderTns: [String]?
    public var reservationIds: [String]?
    ...
    func encodeToJSON() -> AnyObject {
        ...
        nillableDictionary["orderTns"] = self.orderTns?.encodeToJSON()
        nillableDictionary["reservationIds"] = self.reservationIds?.encodeToJSON()
