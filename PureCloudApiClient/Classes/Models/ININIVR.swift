...
public class ININIVR: JSONEncodable {
    ...
    public var ivrUri: String?
    public var dnis: [String]?
    public var flowId: String?
    public var scheduleId: String?
    public var openHoursFlow: ININUriReference?
    public var closedHoursFlow: ININUriReference?
    public var scheduleGroup: ININUriReference?
    ...
    func encodeToJSON() -> AnyObject {
        ...
        nillableDictionary["ivrUri"] = self.ivrUri
        nillableDictionary["dnis"] = self.dnis?.encodeToJSON()
        nillableDictionary["flowId"] = self.flowId
        nillableDictionary["scheduleId"] = self.scheduleId
        nillableDictionary["openHoursFlow"] = self.openHoursFlow?.encodeToJSON()
        nillableDictionary["closedHoursFlow"] = self.closedHoursFlow?.encodeToJSON()
        nillableDictionary["scheduleGroup"] = self.scheduleGroup?.encodeToJSON()
