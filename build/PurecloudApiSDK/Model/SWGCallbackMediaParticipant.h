...
@protocol SWGCallbackMediaParticipant
@end

@interface SWGCallbackMediaParticipant : SWGObject
...
/* The outbound preview associated with this callback. [optional]
 */
@property(nonatomic) SWGDialerPreview* outboundPreview;
/* The list of phone number to use for this callback. [optional]
 */
@property(nonatomic) NSArray<NSString*>* callbackNumbers;
/* The name of the callback target. [optional]
 */
@property(nonatomic) NSString* callbackUserName;
/* If true, the callback can be skipped [optional]
 */
@property(nonatomic) NSNumber* skipEnabled;
/* Duration in seconds before the callback will be auto-dialed. [optional]
 */
