...
@implementation SWGPolicyCreate
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"_id", @"modifiedDate", @"createdDate", @"order", @"_description", @"enabled", @"mediaPolicies", @"conditions", @"actions", @"policyErrors", @"selfUri"];
