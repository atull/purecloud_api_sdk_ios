...
@protocol SWGDomainEntityListingEvaluationForm
@end

@interface SWGDomainEntityListingEvaluationForm : SWGObject


@property(nonatomic) NSArray<SWGEvaluationForm>* entities;
