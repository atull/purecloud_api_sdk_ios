...
@protocol SWGDomainEdgeSoftwareVersionDtoEntityListing
@end

@interface SWGDomainEdgeSoftwareVersionDtoEntityListing : SWGObject


@property(nonatomic) NSArray<SWGDomainEdgeSoftwareVersionDto>* entities;
