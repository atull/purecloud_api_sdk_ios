...
@interface SWGGeolocationApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGGeolocationApi

NSString* kSWGGeolocationApiErrorDomain = @"SWGGeolocationApiErrorDomain";
NSInteger kSWGGeolocationApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGGeolocationApi *sharedAPI;
...
/// 
///  @returns SWGGeolocationSettings*
///
-(NSNumber*) getGeolocationsSettingsWithCompletionHandler: 
    (void (^)(SWGGeolocationSettings* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/geolocations/settings"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGGeolocationSettings*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGGeolocationSettings*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getUsersUserIdGeolocationsClientIdWithUserId: (NSString*) userId
    ...
    if (userId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGGeolocationApiErrorDomain code:kSWGGeolocationApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
