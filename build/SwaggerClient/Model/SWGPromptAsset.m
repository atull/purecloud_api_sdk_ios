...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"_id", @"name", @"promptId", @"language", @"mediaUri", @"ttsString", @"uploadStatus", @"uploadUri", @"languageDefault", @"tags", @"durationSeconds", @"selfUri"];
