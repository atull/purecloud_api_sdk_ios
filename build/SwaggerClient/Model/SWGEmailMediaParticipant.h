...
@protocol SWGEmailMediaParticipant
@end

@interface SWGEmailMediaParticipant : SWGObject
...
/* The number of messages that have been sent in this email conversation. [optional]
 */
