...
@protocol SWGVideoMediaParticipant
@end

@interface SWGVideoMediaParticipant : SWGObject
...
/* Value is true when audio is muted. [optional]
 */
@property(nonatomic) NSNumber* audioMuted;
/* Value is true when video is muted. [optional]
 */
@property(nonatomic) NSNumber* videoMuted;
/* Value is true when screen sharing is enabled. [optional]
 */
@property(nonatomic) NSNumber* sharingScreen;
/* The number of peers of this participant. [optional]
 */
@property(nonatomic) NSNumber* peerCount;
/* The context for this participant. [optional]
 */
