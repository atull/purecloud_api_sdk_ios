...
@protocol SWGDomainVoiceRateInternationalResponseItemEntityListing
@end

@interface SWGDomainVoiceRateInternationalResponseItemEntityListing : SWGObject


@property(nonatomic) NSArray<SWGVoiceRateInternational>* entities;
