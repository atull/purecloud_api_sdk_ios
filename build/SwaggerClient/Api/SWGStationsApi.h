...
@interface SWGStationsApi: NSObject <SWGApi>

extern NSString* kSWGStationsApiErrorDomain;
extern NSInteger kSWGStationsApiMissingParamErrorCode;
...
///  code:504 message:"The request timed out."
///
/// @return SWGStationEntityListing*
