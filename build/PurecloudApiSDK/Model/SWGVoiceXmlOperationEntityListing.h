...
@protocol SWGVoiceXmlOperationEntityListing
@end

@interface SWGVoiceXmlOperationEntityListing : SWGObject


@property(nonatomic) NSArray<SWGVoiceXmlOperation>* entities;
