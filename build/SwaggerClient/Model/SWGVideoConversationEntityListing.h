...
@protocol SWGVideoConversationEntityListing
@end

@interface SWGVideoConversationEntityListing : SWGObject


@property(nonatomic) NSArray<SWGVideoConversation>* entities;
