...
@protocol SWGExtension
@end

@interface SWGExtension : SWGObject
...
/* A Uri reference to the owner of this extension, which is either a User or an IVR [optional]
 */
@property(nonatomic) SWGUriReference* owner;

@property(nonatomic) SWGUriReference* extensionPool;
