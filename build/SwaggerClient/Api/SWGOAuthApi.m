...
-(NSNumber*) deleteOauthClientsClientIdWithClientId: (NSString*) clientId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/oauth/clients/{clientId}"];
...
/// 
///  @returns SWGOAuthClientEntityListing*
///
-(NSNumber*) getOauthClientsWithCompletionHandler: 
    (void (^)(SWGOAuthClientEntityListing* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/oauth/clients"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGOAuthClientEntityListing*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGOAuthClientEntityListing*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getOauthClientsClientIdWithClientId: (NSString*) clientId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGOAuthClient*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGOAuthClient*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) postOauthClientsClientIdSecretWithClientId: (NSString*) clientId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/oauth/clients/{clientId}/secret"];
