...
**outboundPreview** | [**SWGDialerPreview***](SWGDialerPreview.md) | The outbound preview associated with this callback. | [optional] 
**callbackNumbers** | **NSArray&lt;NSString*&gt;*** | The list of phone number to use for this callback. | [optional] 
**callbackUserName** | **NSString*** | The name of the callback target. | [optional] 
**skipEnabled** | **NSNumber*** | If true, the callback can be skipped | [optional] [default to @0]
**timeoutSeconds** | **NSNumber*** | Duration in seconds before the callback will be auto-dialed. | [optional] 
