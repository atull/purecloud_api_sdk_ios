...
@protocol SWGDomainVoiceRateExtendedResponseItemEntityListing
@end

@interface SWGDomainVoiceRateExtendedResponseItemEntityListing : SWGObject


@property(nonatomic) NSArray<SWGVoiceRateExtended>* entities;
