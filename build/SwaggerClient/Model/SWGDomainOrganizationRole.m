...
@implementation SWGDomainOrganizationRole
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"_id", @"name", @"_description", @"defaultRoleId", @"permissions", @"permissionPolicies", @"userCount", @"roleNeedsUpdate", @"base", @"_default", @"selfUri"];
