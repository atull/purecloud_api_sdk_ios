...
@protocol SWGExtensionPool
@end

@interface SWGExtensionPool : SWGObject
...
/* The starting phone number for the range of this Extension pool. Must be in E.164 format [optional]
 */
@property(nonatomic) NSString* startNumber;
/* The ending phone number for the range of this Extension pool. Must be in E.164 format [optional]
 */
@property(nonatomic) NSString* endNumber;
