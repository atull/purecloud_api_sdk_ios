//
// ININJsonNodeSearchResponse.swift
//
...
public class ININJsonNodeSearchResponse: JSONEncodable {
    ...
    public var results: ININJsonNode?
    public var aggregations: ININJsonNode?
