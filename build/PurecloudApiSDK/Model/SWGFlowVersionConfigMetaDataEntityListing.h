...
@protocol SWGFlowVersionConfigMetaDataEntityListing
@end

@interface SWGFlowVersionConfigMetaDataEntityListing : SWGObject


@property(nonatomic) NSArray<SWGFlowVersionConfigMetaData>* entities;
