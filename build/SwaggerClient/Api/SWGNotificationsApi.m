...
@interface SWGNotificationsApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGNotificationsApi

NSString* kSWGNotificationsApiErrorDomain = @"SWGNotificationsApiErrorDomain";
NSInteger kSWGNotificationsApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGNotificationsApi *sharedAPI;
...
-(NSNumber*) deleteNotificationsChannelsChannelIdSubscriptionsWithChannelId: (NSString*) channelId
    ...
    if (channelId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGNotificationsApiErrorDomain code:kSWGNotificationsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/notifications/channels/{channelId}/subscriptions"];
...
///
///  @returns SWGAvailableTopicEntityListing*
///
-(NSNumber*) getNotificationsAvailabletopicsWithExpand: (NSArray<NSString*>*) expand
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/notifications/availabletopics"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGAvailableTopicEntityListing*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGAvailableTopicEntityListing*)data, error);
                                }
                           }
          ];
}
...
/// 
///  @returns SWGChannelEntityListing*
///
-(NSNumber*) getNotificationsChannelsWithCompletionHandler: 
    (void (^)(SWGChannelEntityListing* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/notifications/channels"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGChannelEntityListing*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGChannelEntityListing*)data, error);
                                }
                           }
          ];
}
...
///  @param channelId Channel ID 
///
///  @returns SWGChannelTopicEntityListing*
///
-(NSNumber*) getNotificationsChannelsChannelIdSubscriptionsWithChannelId: (NSString*) channelId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGChannelTopicEntityListing*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGChannelTopicEntityListing*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) postNotificationsChannelsWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGChannel*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGChannel*)data, error);
                                }
                           }
          ];
}
