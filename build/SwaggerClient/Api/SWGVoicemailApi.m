...
+ (instancetype)sharedAPI {
    static SWGVoicemailApi *sharedAPI;
...
-(NSNumber*) deleteVoicemailMessagesWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/voicemail/messages"];
...
-(NSNumber*) deleteVoicemailMessagesMessageIdWithMessageId: (NSString*) messageId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/voicemail/messages/{messageId}"];
...
/// 
///  @returns SWGVoicemailMailboxInfo*
///
-(NSNumber*) getVoicemailMailboxWithCompletionHandler: 
    (void (^)(SWGVoicemailMailboxInfo* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/voicemail/mailbox"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGVoicemailMailboxInfo*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGVoicemailMailboxInfo*)data, error);
                                }
                           }
          ];
}
...
/// 
///  @returns SWGVoicemailMessageEntityListing*
///
-(NSNumber*) getVoicemailMessagesWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGVoicemailMessageEntityListing*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGVoicemailMessageEntityListing*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getVoicemailMessagesMessageIdWithMessageId: (NSString*) messageId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGVoicemailMessage*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGVoicemailMessage*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getVoicemailMessagesMessageIdMediaWithMessageId: (NSString*) messageId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/voicemail/messages/{messageId}/media"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGVoicemailMediaInfo*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGVoicemailMediaInfo*)data, error);
                                }
                           }
          ];
}
...
/// Get a policy
/// 
///  @returns SWGVoicemailOrganizationPolicy*
///
-(NSNumber*) getVoicemailPolicyWithCompletionHandler: 
    (void (^)(SWGVoicemailOrganizationPolicy* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/voicemail/policy"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGVoicemailOrganizationPolicy*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGVoicemailOrganizationPolicy*)data, error);
                                }
                           }
          ];
}
...
///
///  @returns SWGVoicemailUserPolicy*
///
-(NSNumber*) getVoicemailUserpoliciesUserIdWithUserId: (NSString*) userId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/voicemail/userpolicies/{userId}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGVoicemailUserPolicy*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGVoicemailUserPolicy*)data, error);
                                }
                           }
          ];
}
