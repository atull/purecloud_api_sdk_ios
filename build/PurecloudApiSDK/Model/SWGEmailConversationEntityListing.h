...
@protocol SWGEmailConversationEntityListing
@end

@interface SWGEmailConversationEntityListing : SWGObject


@property(nonatomic) NSArray<SWGEmailConversation>* entities;
