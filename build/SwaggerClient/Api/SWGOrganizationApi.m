...
@interface SWGOrganizationApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGOrganizationApi

NSString* kSWGOrganizationApiErrorDomain = @"SWGOrganizationApiErrorDomain";
NSInteger kSWGOrganizationApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGOrganizationApi *sharedAPI;
...
-(NSNumber*) getFieldconfigWithType: (NSString*) type
    ...
    if (type == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGOrganizationApiErrorDomain code:kSWGOrganizationApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
...
-(NSNumber*) getOrganizationsMeWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v2/organizations/me"];
