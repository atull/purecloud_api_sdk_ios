...
@protocol SWGLocalEncryptionConfigurationListing
@end

@interface SWGLocalEncryptionConfigurationListing : SWGObject


@property(nonatomic) NSArray<SWGLocalEncryptionConfiguration>* entities;
