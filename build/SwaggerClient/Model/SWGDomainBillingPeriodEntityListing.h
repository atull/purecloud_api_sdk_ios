...
@protocol SWGDomainBillingPeriodEntityListing
@end

@interface SWGDomainBillingPeriodEntityListing : SWGObject


@property(nonatomic) NSArray<SWGBillingPeriod>* entities;
