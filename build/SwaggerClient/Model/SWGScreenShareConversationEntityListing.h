...
@protocol SWGScreenShareConversationEntityListing
@end

@interface SWGScreenShareConversationEntityListing : SWGObject


@property(nonatomic) NSArray<SWGScreenShareConversation>* entities;
