...
@protocol SWGAvailableAdditionalServiceListing
@end

@interface SWGAvailableAdditionalServiceListing : SWGObject


@property(nonatomic) NSArray<SWGAvailableAdditionalService>* entities;
