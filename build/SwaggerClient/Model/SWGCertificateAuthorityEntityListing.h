...
@protocol SWGCertificateAuthorityEntityListing
@end

@interface SWGCertificateAuthorityEntityListing : SWGObject


@property(nonatomic) NSArray<SWGDomainCertificateAuthority>* entities;
