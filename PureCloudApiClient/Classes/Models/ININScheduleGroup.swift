...
public class ININScheduleGroup: JSONEncodable {
    ...
    public var openSchedules: [ININUriReference]?
    public var closedSchedules: [ININUriReference]?
    ...
    func encodeToJSON() -> AnyObject {
        ...
        nillableDictionary["openSchedules"] = self.openSchedules?.encodeToJSON()
        nillableDictionary["closedSchedules"] = self.closedSchedules?.encodeToJSON()
