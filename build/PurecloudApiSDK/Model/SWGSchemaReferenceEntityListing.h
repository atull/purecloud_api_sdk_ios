...
@protocol SWGSchemaReferenceEntityListing
@end

@interface SWGSchemaReferenceEntityListing : SWGObject


@property(nonatomic) NSArray<SWGDomainSchemaReference>* entities;
