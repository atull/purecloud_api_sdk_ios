...
@protocol SWGJsonNodeSearchResponse
@end

@interface SWGJsonNodeSearchResponse : SWGObject
...
/* Search results 
 */
@property(nonatomic) SWGJsonNode* results;

@property(nonatomic) SWGJsonNode* aggregations;
