...
**audioMuted** | **NSNumber*** | Value is true when audio is muted. | [optional] [default to @0]
**videoMuted** | **NSNumber*** | Value is true when video is muted. | [optional] [default to @0]
**sharingScreen** | **NSNumber*** | Value is true when screen sharing is enabled. | [optional] [default to @0]
