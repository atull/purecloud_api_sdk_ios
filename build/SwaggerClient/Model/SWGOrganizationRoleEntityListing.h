...
@protocol SWGOrganizationRoleEntityListing
@end

@interface SWGOrganizationRoleEntityListing : SWGObject


@property(nonatomic) NSArray<SWGDomainOrganizationRole>* entities;
