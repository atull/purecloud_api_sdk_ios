...
@protocol SWGUserActionCategoryEntityListing
@end

@interface SWGUserActionCategoryEntityListing : SWGObject


@property(nonatomic) NSArray<SWGUserActionCategory>* entities;
