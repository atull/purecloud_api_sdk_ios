...
@protocol SWGOrganizationPresenceEntityListing
@end

@interface SWGOrganizationPresenceEntityListing : SWGObject


@property(nonatomic) NSArray<SWGOrganizationPresence>* entities;
