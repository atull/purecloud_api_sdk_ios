//
// ININResourceConditionNode.swift
//
...
public class ININResourceConditionNode: JSONEncodable {
    ...
    public var operands: [ININResourceConditionValue]?
    public var terms: [ININResourceConditionNode]?
