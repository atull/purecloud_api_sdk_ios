...
@protocol SWGFlowConfigMetaDataEntityListing
@end

@interface SWGFlowConfigMetaDataEntityListing : SWGObject


@property(nonatomic) NSArray<SWGFlowConfigMetaData>* entities;
