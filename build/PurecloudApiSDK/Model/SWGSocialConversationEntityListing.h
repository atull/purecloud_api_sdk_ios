...
@protocol SWGSocialConversationEntityListing
@end

@interface SWGSocialConversationEntityListing : SWGObject


@property(nonatomic) NSArray<SWGSocialConversation>* entities;
